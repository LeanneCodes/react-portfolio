      ...
      <div className='about-container container-fluid' id='about'>
        <div className='about-info'>
          ...
          <div className='text-pos'>
            ...
            <br/>
            <br/>
            To have a thorough understanding of Frontend Development, I completed two bootcamps. <a href='https://www.credential.net/abe70729-0419-4049-a752-62b032d231eb#gs.08qmqt' target='_blank' style={{color: 'var(--coral)'}}>Fullstack Merit Diploma</a> and a Frontend Development Certificate pending.
            <br/>
            <br/>
